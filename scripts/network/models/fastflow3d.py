...
class FastFlow3D(nn.Module):
    ...
    def forward(self, batch,
        ...
        pc0s = torch.stack(transform_pc0s, dim=0).cuda()
        pc1s = batch["pc1"].cuda()
        ...
        # points_original = selected_pc0.detach().cpu().numpy()
        # pcd1.points = o3d.utility.Vector3dVector(points_original)
        ...
        # points_added = pc1s.detach().cpu().numpy()[0][-5000:]
        # pcd3.points = o3d.utility.Vector3dVector(points_added)
